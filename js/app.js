...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const elementsToToggle = [document.body, document.querySelector('body'), document.querySelector('.bg-image'), document.querySelector('.intro-text'), document.querySelector('.intro-text-2'), document.querySelector('.intro-heading')];
